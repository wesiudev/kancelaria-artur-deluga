...
export default function Home() {
  return (
    <div className="absolute left-0 top-0 w-screen h-screen z-[1500] overflow-x-hidden">
      ...
      <div
        className={`w-screen min-h-screen bg-gradient-to-b from-black to-zinc-800 select-none`}
      >
        <div id="zakres-uslug" className="w-4/5 lg:w-3/4 mx-auto relative">
          ...
          <h2 className="text-center text-xl w-full lg:w-3/4 mx-auto py-24">
          ...
          <Link
            href="#cennik"
            className="bg-white text-black shadow-md shadow-white p-3  text-xl mx-auto absolute -bottom-24 left-[50%] -translate-x-[50%]"
          >
            Sprawdź ceny
          </Link>
        </div>
