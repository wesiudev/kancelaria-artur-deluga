      ...
      >
        <div className=" w-4/5 lg:w-3/4 mx-auto">
          ...
          <div className="flex flex-col">
            <div className="px-3 border-l border-r border-white bg-black bg-opacity-50 flex flex-col space-y-3">
              <h1>Prawo Karne</h1>
              <p>
            ...
            <div className="px-3 border-l border-r border-white bg-black bg-opacity-50 flex flex-col">
              <h1>Prawo cywilne</h1>
            </div>
            <div className="px-3 border-l border-r border-white bg-black bg-opacity-50 flex flex-col">
