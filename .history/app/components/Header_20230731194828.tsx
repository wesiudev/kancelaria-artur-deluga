export default function Header() {
  return (
    <div className="h-max w-max md:w-max mx-auto md:ml-[12vw] my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-gray-500 shadow-md shadow-white md:shadow-none">
