...
export default function Header({ marginLeft }: { marginLeft: number }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center absolute left-[50%] translate-x-[50%] lg:-translate-x-[0%]  top-[50%] -translate-y-[50%] lg:flex-row  lg:justify-between w-full  lg:fixed  lg:w-max">
        <div
          style={{
