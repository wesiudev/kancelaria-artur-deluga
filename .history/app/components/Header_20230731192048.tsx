export default function Header(setCurrentPage: Function) {
  return (
    <div className="h-max w-max md:w-max mx-auto md:ml-[12vw] my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black shadow-md shadow-white md:shadow-none">
      <div className="flex flex-row items-center w-full relative">
        <div className="flex flex-col h-max justify-center">
          ...
          <div className="flex-row hidden md:flex  w-full text-left mt-6">
