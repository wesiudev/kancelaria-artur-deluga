...
export default function OfferMobile() {
  return (
    <div className="fixed left-0 top-0 w-full mx-auto z-[2000] bg-gradient-to-r from-black via-zinc-800 to-black my-24">
      <div className="flex flex-col space-x-[100px] min-h-screen  overflow-y-scroll">
        <div className="flex flex-col w-[90vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center  pl-[12vw]">
          <Image
            src={paragraphImage}
          ...
          <div className="relative text-black mt-12 grid grid-cols-1">
