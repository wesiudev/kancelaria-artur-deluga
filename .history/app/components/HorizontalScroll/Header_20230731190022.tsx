    ...
    <div className="h-max w-max md:w-max mx-auto md:ml-[12vw] my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black shadow-md shadow-white">
      <div className="flex flex-row items-center w-full relative">
        <div className="flex flex-col h-max justify-center">
          ...
          <div className="flex-row hidden md:flex items-start w-max text-left mt-6">
            <button className="text-xl space-x-2 w-max">Cennik</button>
            <button className="text-xl space-x-2 w-max">Zakres usług</button>
            <button className="text-xl space-x-2 w-max">Kontakt</button>
          </div>
        </div>
      </div>
    </div>
