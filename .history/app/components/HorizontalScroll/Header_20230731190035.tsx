      ...
      <div className="flex flex-row items-center w-full relative">
        <div className="flex flex-col h-max justify-center">
          ...
          <div className="flex-row hidden md:flex items-start w-max text-left mt-6">
            <button className="text-xl mx-2 w-max">Cennik</button>
            <button className="text-xl mx-2 w-max">Zakres usług</button>
            <button className="text-xl mx-2 w-max">Kontakt</button>
          </div>
        </div>
      </div>
    </div>
