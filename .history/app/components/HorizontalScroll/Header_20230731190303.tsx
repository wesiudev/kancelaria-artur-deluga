      ...
      <div className="flex flex-row items-center w-full relative">
        <div className="flex flex-col h-max justify-center">
          ...
          <div className="flex-row hidden md:flex justify-between  w-full text-left mt-6">
            <button className="text-xl w-max underlinee">Cennik</button>
            <button className="text-xl w-max underlinee">Zakres usług</button>
            <button className="text-xl w-max underlinee">Kontakt</button>
          </div>
        </div>
      </div>
    </div>
