...
export default function Offer({ scroll }: { scroll: number }) {
  return (
    <div
      ...
      className={`lg:min-w-[200vw] 2xl:min-w-[150vw]  h-screen bg-gradient-to-b from-black via-zinc-800 to-black select-none pb-24 duration-500  fixed top-0 px-[12vw]`}
    >
      <div className="w-full mx-auto">
        <div className="flex flex-row space-x-[100px]">
          ...
          <div className="flex flex-col h-max my-auto px-12 border-l border-r border-white  text-center relative">
            ...
            <div className="absolute -bottom-24 left-[50%] -translate-x-[50%] p-3 bg-purple-300 text-black">
              Wypełnij formularz
            </div>
          </div>
        </div>
