...
export default function Offer({ scroll }: { scroll: number }) {
  ...
  return (
    <div
      style={{
        transform: `translateX(${wrapperRef.current.offsetWidth - scroll}vh)`,
      }}
      ref={wrapperRef}
      className={`w-max h-screen  bg-gradient-to-b from-black to-zinc-800 select-none pb-24 duration-500  absolute top-0 right-0`}
    >
