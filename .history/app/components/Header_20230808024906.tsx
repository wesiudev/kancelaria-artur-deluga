...
export default function Header({ marginLeft }: { marginLeft: number }) {
  ...
  return (
    <div className="h-max w-max mx-auto my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black ">
      ...
      <div className="absolute bottom-24 w-full left-[50%] -translate-x-[50%] lg:hidden flex-row items-center text-center justify-center text-2xl lg:text-4xl my-4">
        <FaPhone />
        <a className="text-blue-400 ml-1 text-center" href="tel:+48502637727">
          Zadzwoń
        </a>
      </div>
      <div
