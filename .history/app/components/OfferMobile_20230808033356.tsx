...
export default function OfferMobile() {
  return (
    <div className="fixed left-0 top-0 w-full mx-auto z-[2000] bg-gradient-to-r from-black via-zinc-800 to-black overflow-y-scroll">
      <div className="flex flex-col space-x-[100px] min-h-screen items-center">
        <div className="flex flex-col w-[90vw] lg:w-[70vw] 2xl:w-[60vw] h-screen justify-center ">
          <Image
            src={paragraphImage}
          ...
          <div className="relative text-black flex flex-col space-x-12 mr-24">
