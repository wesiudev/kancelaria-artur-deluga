    ...
    >
      <div className="w-full mx-auto">
        <div className="flex flex-row space-x-[100px]">
          ...
          <div className="flex flex-col w-px overflow-hidden duration-1000 h-max my-auto px-12 border-l border-r border-white  text-center relative ">
            <h1 className="text-7xl ">Cennik</h1>
            <p className="mt-6 text-2xl w-max mx-auto">
            ...
            <p className="mt-3 text-2xl w-max mx-auto">
              W przypadku stałej obsługi wynagrodzenie w formie
              <span className="font-bold w-max mx-auto">
                {" "}
