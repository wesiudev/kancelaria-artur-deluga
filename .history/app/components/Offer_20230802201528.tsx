        ...
        <div className="flex flex-row space-x-[100px]">
          ...
          <div className="relative text-black flex flex-row space-x-12">
            <div className="flex flex-col space-y-6 w-[60vw]">
              <div className="h-max  border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-l-2 md:border-t-2 border-black bg-white bg-opacity-75 flex flex-col py-3">
              ...
              <div className="h-max border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-t-2 md:border-r-2 border-black bg-white bg-opacity-75 flex flex-col py-3">
            ...
            <div className="flex flex-col space-y-6 w-[60vw]">
              <div className="h-max  border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-l-2 md:border-b-2 border-black bg-white bg-opacity-75 flex flex-col py-3">
              ...
              <div className="h-max  border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-r-2 md:border-b-2 border-black bg-white bg-opacity-75 flex flex-col py-3">
