export default function Offer({ scroll }: { scroll: number }) {
  return (
    <div
      ...
      className={`lg:w-[200vw] lg:-right-[200vw] 2xl:w-[150vw] 2xl:-right-[130vw] h-screen  bg-gradient-to-b from-black to-zinc-800 select-none pb-24 duration-500  fixed top-0 `}
    >
