...
export default function Header({ marginLeft }: { marginLeft: number }) {
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] lg:flex-row  lg:justify-between w-full  lg:fixed  lg:w-max">
        <div
          style={{
            transform: `translateX(${
              width > 1024 && marginLeft > 25 ? 50 - 0.8 * marginLeft : "50"
            }%)`,
          }}
