...
export default function Header({
  ...
  return (
    <div
      className={`${
        marginLeft > 150 && !isVisible && width > 1024 && "hidden"
      } h-max w-max mx-auto my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black relative`}
    >
      <div ref={nodeRef} className="absolute right-1 h-full w-2"></div>
