...
export default function Offer({ scroll }: { scroll: number }) {
  return (
    <div
      style={{ transform: `translateX(${-scroll * 0.8}vh)` }}
      className={`lg:w-[200vw] lg:-right-[200vw] 2xl:w-[150vw] 2xl:-right-[150vw] h-screen bg-gradient-to-b from-black to-zinc-800 select-none pb-24 duration-500  fixed top-0 `}
    >
