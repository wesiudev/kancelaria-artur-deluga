...
export default function Header({ marginLeft }: { marginLeft: number }) {
  ...
  return (
    <div className="h-max w-max mx-auto my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black ">
      <div className="flex flex-col items-center absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] lg:flex-row  lg:justify-between w-full lg:left-0 lg:fixed lg:-translate-x-[0%] lg:w-[full]">
        <div
          style={{
        ...
        >
          <h1 className="text-2xl text-center sm:text-4xl lg:text-7xl font-bold ">
          ...
          <div className="w-max mx-auto text-center ">
            ...
            <div
              className={`flex flex-row space-x-2 text-sm lg:text-xl justify-center w-full mt-6`}
            >
