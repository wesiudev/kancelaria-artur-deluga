      ...
      <div className="w-full mx-auto">
        <div className="flex flex-row ">
          ...
          <div className="ml-[12vw]">
            <div className="top-[50%] -translate-y-[50%] border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-l-2 md:border-t-2 border-black bg-white bg-opacity-75 flex flex-col py-3">
