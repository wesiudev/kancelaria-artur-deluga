...
export default function Header() {
  ...
  return (
    <div className={`h-max w-max mx-auto my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black ">
      <div className="flex flex-col items-center lg:items-start lg:mt-12 absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] lg:flex-row  lg:justify-between w-full lg:left-[0%] lg:-translate-x-[0%] lg:top-[0%] lg:-translate-y-[0%] ${scrollY > 100 ? "fixed top-0 lg:w-full left-0" : "lg:w-3/4 lg:relative"}`}>
