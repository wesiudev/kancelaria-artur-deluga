...
export default function Offer({ scroll }: { scroll: number }) {
  return (
    <div
      style={{
        transform: `translateX(${scroll > 0 ? 100 - scroll : "50"}${
          scroll > 0 ? "vh" : "%"
        })`,
      }}
      className={`lg:min-w-[200vw] 2xl:min-w-[150vw]  h-screen bg-gradient-to-b from-black to-zinc-800 select-none pb-24 duration-500  fixed top-0 pr-[12vw]`}
    >
      <div className="w-full mx-auto">
        <div className="flex flex-row space-x-[12vw]">
          <div className="flex flex-col w-[50vw] h-screen justify-center  pl-[12vw]">
            <Image
              src={paragraphImage}
          ...
          <div className="ml-[12vw] relative text-black flex flex-row space-x-12">
            <div className="h-max my-auto border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-l-2 md:border-t-2 border-black bg-white bg-opacity-75 flex flex-col py-3 w-[50vw]">
            ...
            <div className="h-max my-auto border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-t-2 md:border-r-2 border-black bg-white bg-opacity-75 flex flex-col py-3 w-[50vw]">
            ...
            <div className="h-max my-auto border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-l-2 md:border-b-2 border-black bg-white bg-opacity-75 flex flex-col py-3 w-[50vw]">
            ...
            <div className="h-max my-auto border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-r-2 md:border-b-2 border-black bg-white bg-opacity-75 flex flex-col py-3 w-[50vw]">
