export default function Header() {
  return (
    <div className="h-max w-max mx-auto md:w-3/4 my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black ">
      <div className="flex flex-col items-center absolute left-[50%] -translate-x-[50%] top-[40%] -translate-y-[50%] xl:flex-row  xl:justify-between w-full xl:relative xl:left-[0%] xl:-translate-x-[0%] md:top-[0%] xl:-translate-y-[0%]">
