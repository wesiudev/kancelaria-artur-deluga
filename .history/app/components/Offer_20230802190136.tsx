      ...
      <div className="w-full mx-auto">
        <div className="flex flex-row ">
          ...
          <div className="ml-[12vw] relative text-black flex flex-row space-x-12">
            <div className="border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 md:border-l-2 md:border-t-2 border-black bg-white bg-opacity-75 flex flex-col py-3 w-[50vw]">
