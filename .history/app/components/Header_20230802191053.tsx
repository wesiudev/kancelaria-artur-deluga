...
export default function Header({ marginLeft }: { marginLeft: number }) {
  return (
    <div className="h-max w-max mx-auto my-auto md:my-0 text-white z-[1500] select-none py-6 px-3 md:bg-black ">
      <div className="flex flex-col items-center absolute lg:left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] lg:flex-row  lg:justify-between w-full lg:left-0 lg:fixed lg:-translate-x-[0%] lg:top-[50%] lg:-translate-y-[50%]">
        <div
          style={{
            transform: `translateX(${
              marginLeft < 50 ? 50 - 0.8 * marginLeft : "-50"
            }%)`,
          }}
          className="-translate-x-[50%] flex flex-col h-max justify-center ml-3 duration-500"
        >
