      ...
      >
        <div className=" w-4/5 lg:w-3/4 mx-auto">
          ...
          <div className="grid grid-cols-2 gap-6 mt-12 text-black">
            <div className="hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 border-l border-t border-black bg-white bg-opacity-50 flex flex-col py-3">
            ...
            <div className="hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 border-t border-r border-black bg-white bg-opacity-50 flex flex-col py-3">
            ...
            <div className="hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 border-l border-b border-black bg-white bg-opacity-50 flex flex-col py-3">
            ...
            <div className="hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 border-r border-b border-black bg-white bg-opacity-50 flex flex-col py-3">
