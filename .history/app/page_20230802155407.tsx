  ...
  return (
    <div className="absolute left-0 top-0 w-screen h-screen z-[1500] overflow-x-hidden">
      <div className="relative w-full h-screen">
        ...
        <div
          className={`flex flex-row space-x-2 text-xs lg:text-lg lg:flex-col bottom-[10vh] left-[50%] -translate-x-[50%] justify-center lg:justify-start w-full lg:w-max lg:left-[12vw] absolute`}
        >
