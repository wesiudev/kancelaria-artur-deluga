      ...
      <div className={`relative w-full h-full duration-1000 overflow-hidden`}>
        ...
        <div className=" ml-[12vw] relative overflow-x-hidden">
          <div
            ...
            className={`hidden lg:block lg:min-w-[200vw] 2xl:min-w-[150vw]  h-screen bg-gradient-to-b from-zinc-700 via-gray-800 to-zinc-700 select-none pb-24 duration-500  fixed top-0 pr-[12vw]`}
          >
