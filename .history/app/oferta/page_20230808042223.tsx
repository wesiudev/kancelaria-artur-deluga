    ...
    <div className="w-full mx-auto z-[2000] bg-gradient-to-r from-black via-zinc-800 to-black overflow-x-hidden">
      <div className="flex flex-col space-x-[100px] min-h-screen items-center py-24">
        <div className="flex flex-col w-[85vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center ">
          ...
          <div className="flex flex-col h-max my-auto px-6 lg:px-12 border-l border-r border-white  text-center relative w-[85vw] mt-12 lg:w-[60vw]">
            ...
            <p className="mt-3 text-base lg:text-2xl">
              W przypadku stałej obsługi wynagrodzenie w formie
              <span className="font-bold"> miesięcznego ryczałtu</span>.
            </p>
            <button
              onClick={() => setContactOpen(true)}
              className=" p-3 bg-purple-400 text-white hover:bg-purple-300 duration-300 text-black mt-12 w-max mx-auto"
            >
              Wypełnij formularz
            </button>
          </div>
