      ...
      <div className="flex flex-col space-x-[100px] min-h-screen items-center py-24">
        <div className="flex flex-col w-[85vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center ">
          ...
          <div className="flex flex-col justify-between w-full">
            <div className="flex flex-row justify-between">
              <div className="w-max">
                <h1 className="mb-12">
                  {" / "}
                  <Link
                    className="w-max hover:underline hover:underline-offset-4"
                    href="/"
                  >
                    home
                  </Link>
              ...
              <div>
                <h1 className="text-2xl text-right sm:text-left">
                ...
                <div
                  className={`flex flex-row space-x-2 text-sm justify-end w-full mt-3 mb-12`}
                >
            ...
            <Link
              className="group flex flex-row items-center mb-12 text-xl"
              href="/"
            >
          ...
          <div className="relative text-black flex flex-col space-y-12 mt-24">
            <div className="h-[25vh] border-0 hover:scale-105 duration-300 hover:bg-opacity-100 cursor-default  md:border-l-2 md:border-t-2 border-black bg-white  flex flex-col p-6 justify-between">
            ...
            <div className="h-[25vh] border-0 hover:scale-105 duration-300 hover:bg-opacity-100 cursor-default  md:border-l-2 md:border-b-2 border-black bg-white  flex flex-col justify-between p-6">
            ...
            <div className="h-[25vh] border-0 hover:scale-105 duration-300 hover:bg-opacity-100 cursor-default  md:border-t-2 md:border-r-2 border-black bg-white  flex flex-col p-6 justify-between">
            ...
            <div className="h-[25vh] border-0 hover:scale-105 duration-300 hover:bg-opacity-100 cursor-default  md:border-r-2 md:border-b-2 border-black bg-white  flex flex-col p-6 justify-between">
