    ...
    <div className="w-full mx-auto z-[2000] bg-gradient-to-br from-zinc-800 via-zinc-500 to-zinc-800 overflow-x-hidden text-black">
      ...
      <div className="flex flex-col space-x-[100px] min-h-screen items-center py-24">
        <div className="flex flex-col w-[85vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center ">
          ...
          <div
            className={`bg-zinc-700 rounded-full flex-col space-x-2 text-sm justify-center text-center items-center py-3 space-y-3 text-white mt-24 flex lg:hidden z-[1000]`}
          >
          ...
          <Link
            href="/"
            className="group flex flex-row items-center mb-12 text-xl w-max text-white mx-auto duration-300 mt-24 hover:bg-gray-400 rounded-md p-3 z-[2001]"
          >
            <FaArrowLeft className="mr-2 " />
