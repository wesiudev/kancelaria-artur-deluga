        ...
        <div className="flex flex-col w-[85vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center ">
          <div className="flex flex-col justify-between w-full">
            ...
            <div className=" rounded-2xl  text-white">
              <div className="w-max">
                <h1 className="w-max text-4xl md:text-5xl lg:text-7xl text-black caps font-bold">
                  Oferowane usługi
                </h1>
                <div className="h-1 w-full mb-6 bg-rose-200 hue-rotate-30" />
              </div>
          ...
          <div className="text-white flex flex-col h-max my-auto px-3 lg:px-12  text-center relative w-full mt-12  lg:mx-auto lg:mt-24 border-l-2 border-r-2 border-black py-3 lg:py-6 rounded-2xl">
            ...
            <button
              ...
              className=" p-3 bg-purple-400 hover:bg-purple-300 duration-300 text-black mt-6 w-max mx-auto rounded-md"
            >
              Formularz kontaktowy
            </button>
          </div>
          <div
            className={`bg-gray-200 rounded-full flex-row space-x-2 text-sm justify-center mt-12 flex lg:hidden z-[1000]`}
          >
            <div>ul. Kościelna 15-17/7</div>
            <div>86-300 Grudziądz</div>
          </div>
