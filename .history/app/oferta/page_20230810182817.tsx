      ...
      >
        <div className="relative">
          <div
            ...
            } absolute left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] w-full h-full bg-black flex justify-center items-center duration-300`}
          >
            {" "}
            <svg
              aria-hidden="true"
              className="w-16 h-16 mb-12 text-gray-200 animate-spin dark:text-gray-600 fill-green-600"
              viewBox="0 0 100 101"
              fill="none"
          ...
          <div className="flex flex-col space-y-3 mt-6 lg:mt-12 relative">
