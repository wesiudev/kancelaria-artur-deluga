...
export default function OfferMobile() {
  ...
  return (
    <div className="w-full mx-auto z-[2000] bg-gradient-to-r from-black via-zinc-800 to-black overflow-x-hidden">
      <div className="flex flex-col space-x-[100px] min-h-screen items-center py-24">
        <div className="flex flex-col w-[85vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center ">
          ...
          <div className="flex flex-col h-max my-auto px-3 lg:px-12 border-l border-r border-white  text-center relative w-[85vw] mt-12 lg:w-[50vw] lg:mx-auto lg:mt-24 lg:bg-black lg:bg-opacity-75 lg:py-6">
      ...
      <div
        className={`w-[80vw] fixed left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] bg-gradient-to-bl from-black to-zinc-800 w-max h-max px-12 rounded-3xl py-6 duration-300 ${
