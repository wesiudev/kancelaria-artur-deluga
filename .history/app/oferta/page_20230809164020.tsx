...
export default function OfferMobile() {
  ...
  return (
    <div className="w-full mx-auto z-[2000] bg-gradient-to-br from-gray-400 via-zinc-400 to-gray-400 overflow-x-hidden text-black">
      <div className="flex flex-col space-x-[100px] min-h-screen items-center py-24">
        <div className="flex flex-col w-[85vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center ">
          ...
          <div className="text-white flex flex-col h-max my-auto px-3 lg:px-12  text-center relative w-full mt-12  lg:mx-auto lg:mt-24 bg-black  lg:py-6 rounded-2xl">
