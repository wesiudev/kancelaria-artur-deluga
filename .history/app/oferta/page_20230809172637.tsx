    ...
    <div className="w-full mx-auto z-[2000] bg-gradient-to-br from-zinc-800 via-zinc-500 to-zinc-800 overflow-x-hidden text-black">
      ...
      <div className="flex flex-col space-x-[100px] min-h-screen items-center py-24">
        <div className="flex flex-col w-[85vw] lg:w-[70vw] 2xl:w-[60vw] min-h-screen justify-center ">
          ...
          <div className="text-white flex flex-col h-max my-auto px-3 lg:px-12  text-center relative w-full mt-12  lg:mx-auto lg:mt-24 border-l-4 border-r-4 border-green-600 py-3 lg:py-6 bg-gray-400 bg-opacity-25">
          ...
          <Link
            href="/"
            className="mx-auto w-max mt-24 hover:bg-gray-400 rounded-md p-3"
          >
            <FaArrowLeft className="mr-2 " />
            <span className="hover:underline hover:underline-offset-4"> </span>
          </Link>
        </div>
      </div>
      <div
