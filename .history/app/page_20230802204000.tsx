...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className="fixed left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] bg-gradient-to-bl from-black to-zinc-800 min-h-[80vh] min-w-[80vw] z-[2000]">
        Imię: <input type="text" />
        Email: <input type="text" />
        Treść: <textarea name="" id="" cols="30" rows="10"></textarea>
      </div>
