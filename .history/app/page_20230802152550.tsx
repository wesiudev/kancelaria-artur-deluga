      ...
      >
        <div className=" w-4/5 lg:w-3/4 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12 text-black">
            <div className="hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default px-3 border-l-2 border-t-2 border-l-purple-600 bg-white bg-opacity-50 flex flex-col py-3">
