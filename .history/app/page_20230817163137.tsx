              ...
              <div className="flex flex-row space-x-[100px]">
                ...
                <div className="relative text-black flex flex-row space-x-12 mr-24">
                  <div className="flex flex-col justify-center space-y-6 w-[60vw]">
                    <div className="h-[25vh] border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default p-6 md:border-l-2 md:border-t-2 border-black bg-white bg-opacity-75 flex flex-col ">
                    ...
                    <div className="h-[25vh] border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default p-6 md:border-l-2 md:border-b-2 border-black bg-white bg-opacity-75 flex flex-col ">
                  ...
                  <div className="flex flex-col justify-center space-y-6 w-[60vw]">
                    <div className="h-[25vh] border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default p-6 md:border-t-2 md:border-r-2 border-black bg-white bg-opacity-75 flex flex-col ">
                    ...
                    <div className="h-[25vh] border-0 hover:scale-110 duration-300 hover:bg-opacity-100 cursor-default p-6 md:border-r-2 md:border-b-2 border-black bg-white bg-opacity-75 flex flex-col ">
