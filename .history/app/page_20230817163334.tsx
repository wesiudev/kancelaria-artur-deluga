      ...
      <div className="fixed left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%] bg-black h-[101vh] w-[101vw] rounded-3xl">
        {currentScroll < 200 ? (
          ...
          <div
            ...
            } h-screen bg-gradient-to-b from-zinc-700 via-gray-700 to-zinc-700 w-screen duration-1000`}
          ></div>
        )}
      </div>
      <div
      ...
      <div className={`relative w-full h-full duration-1000 overflow-hidden`}>
        ...
        <div className=" ml-[12vw] relative overflow-x-hidden">
          <div
            ...
            className={`hidden lg:block lg:min-w-[200vw] 2xl:min-w-[150vw]  h-screen bg-gradient-to-b from-purple-900 via-gray-700 to-zinc-700 select-none pb-24 duration-500  fixed top-0 pr-[12vw]`}
          >
