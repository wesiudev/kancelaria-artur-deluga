...
export default function Home() {
  ...
  return (
    <div
      ...
      className="absolute left-0 top-0 w-screen h-screen z-[1500] overflow-x-hidden"
    >
      <div className="relative w-full lg:w-1/2 h-screen duration-1000">
        <ThreeGraces />
        <Header />
      ...
      <div
        className={`w-screen min-h-screen bg-gradient-to-b from-black to-zinc-800 select-none  pb-24`}
      >
        <div id="zakres-uslug" className="w-4/5 lg:w-3/4 mx-auto">
          ...
          <Link
            href="#cennik"
            className="bg-white text-black shadow-md shadow-white p-3  text-xl mx-auto "
          >
            Sprawdź ceny
          </Link>
        </div>
