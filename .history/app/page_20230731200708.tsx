      ...
      >
        <div className=" w-4/5 lg:w-3/4 mx-auto">
          ...
          <div className="grid grid-cols-2 gap-6 mt-12">
            <div className="px-3 border-l border-t border-white bg-black bg-opacity-50 flex flex-col py-3">
            ...
            <div className="px-3 border-t border-r border-white bg-black bg-opacity-50 flex flex-col py-3">
              <h1 className="text-3xl">Prawo Karne</h1>
              <p className="text-xl mt-3">
                Pomoc prawna na każdym etapie postępowania karnego między
                innymi:{" "}
            ...
            <div className="px-3 border-l border-b border-white bg-black bg-opacity-50 flex flex-col py-3">
              <h1 className="text-3xl">Prawo Karne</h1>
              <p className="text-xl mt-3">
                Pomoc prawna na każdym etapie postępowania karnego między
                innymi:{" "}
            ...
            <div className="px-3 border-r border-b border-white bg-black bg-opacity-50 flex flex-col py-3">
              <h1 className="text-3xl">Prawo Karne</h1>
              <p className="text-xl mt-3">
                Pomoc prawna na każdym etapie postępowania karnego między
                innymi:{" "}
